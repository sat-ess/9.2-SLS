--------------------------------------------------------
--  DDL for Table SLS$INV$TR$LINES$AMD
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$INV$TR$LINES$AMD" 
  ...
  GRANT INSERT ON "SLS"."SLS$INV$TR$LINES$AMD" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$INV$TR$LINES$AMD" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$INV$TR$LINES$AMD" TO PUBLIC;

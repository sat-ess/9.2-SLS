--------------------------------------------------------
--  DDL for Table SLS$WMS$PICK$ITEM$BC
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$WMS$PICK$ITEM$BC" 
  ...
  GRANT INSERT ON "SLS"."SLS$WMS$PICK$ITEM$BC" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$WMS$PICK$ITEM$BC" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$WMS$PICK$ITEM$BC" TO PUBLIC;

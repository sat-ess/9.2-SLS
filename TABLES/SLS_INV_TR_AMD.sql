--------------------------------------------------------
--  DDL for Table SLS$INV$TR$AMD
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$INV$TR$AMD" 
  ...
  GRANT INSERT ON "SLS"."SLS$INV$TR$AMD" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$INV$TR$AMD" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$INV$TR$AMD" TO PUBLIC;

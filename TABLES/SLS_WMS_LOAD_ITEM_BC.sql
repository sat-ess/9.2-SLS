--------------------------------------------------------
--  DDL for Table SLS$WMS$LOAD$ITEM$BC
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$WMS$LOAD$ITEM$BC" 
  ...
  GRANT INSERT ON "SLS"."SLS$WMS$LOAD$ITEM$BC" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$WMS$LOAD$ITEM$BC" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$WMS$LOAD$ITEM$BC" TO PUBLIC;

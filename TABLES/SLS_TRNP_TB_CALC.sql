--------------------------------------------------------
--  DDL for Table SLS$TRNP$TB$CALC
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$TRNP$TB$CALC" 
  ...
  GRANT INSERT ON "SLS"."SLS$TRNP$TB$CALC" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$TRNP$TB$CALC" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$TRNP$TB$CALC" TO PUBLIC;

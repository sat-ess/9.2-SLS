--------------------------------------------------------
--  DDL for Table SLS$SEI$ITM
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$SEI$ITM" 
  ...
  GRANT UPDATE ON "SLS"."SLS$SEI$ITM" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$SEI$ITM" TO PUBLIC;
  GRANT INSERT ON "SLS"."SLS$SEI$ITM" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$SEI$ITM" TO "APP";

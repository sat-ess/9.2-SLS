--------------------------------------------------------
--  DDL for Table SLS$WMS$CAGE$ITEM
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$WMS$CAGE$ITEM" 
  ...
  GRANT INSERT ON "SLS"."SLS$WMS$CAGE$ITEM" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$WMS$CAGE$ITEM" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$WMS$CAGE$ITEM" TO PUBLIC;

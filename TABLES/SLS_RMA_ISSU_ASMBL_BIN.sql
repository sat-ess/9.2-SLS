--------------------------------------------------------
--  DDL for Table SLS$RMA$ISSU$ASMBL$BIN
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$RMA$ISSU$ASMBL$BIN" 
  ...
  GRANT INSERT ON "SLS"."SLS$RMA$ISSU$ASMBL$BIN" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$RMA$ISSU$ASMBL$BIN" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$RMA$ISSU$ASMBL$BIN" TO PUBLIC;

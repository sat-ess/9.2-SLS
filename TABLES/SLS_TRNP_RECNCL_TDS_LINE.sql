--------------------------------------------------------
--  DDL for Table SLS$TRNP$RECNCL$TDS$LINE
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$TRNP$RECNCL$TDS$LINE" 
  ...
  GRANT INSERT ON "SLS"."SLS$TRNP$RECNCL$TDS$LINE" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$TRNP$RECNCL$TDS$LINE" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$TRNP$RECNCL$TDS$LINE" TO PUBLIC;

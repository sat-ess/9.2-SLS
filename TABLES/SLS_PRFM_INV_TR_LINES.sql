--------------------------------------------------------
--  DDL for Table SLS$PRFM$INV$TR$LINES
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$PRFM$INV$TR$LINES" 
  ...
  GRANT INSERT ON "SLS"."SLS$PRFM$INV$TR$LINES" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$PRFM$INV$TR$LINES" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$PRFM$INV$TR$LINES" TO PUBLIC;

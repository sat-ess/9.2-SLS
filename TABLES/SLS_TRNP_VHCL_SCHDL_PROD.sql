--------------------------------------------------------
--  DDL for Table SLS$TRNP$VHCL$SCHDL$PROD
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$TRNP$VHCL$SCHDL$PROD" 
  ...
  GRANT UPDATE ON "SLS"."SLS$TRNP$VHCL$SCHDL$PROD" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$TRNP$VHCL$SCHDL$PROD" TO PUBLIC;
  GRANT INSERT ON "SLS"."SLS$TRNP$VHCL$SCHDL$PROD" TO PUBLIC;

--------------------------------------------------------
--  DDL for Table SLS$RMA$ISSU$SR
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$RMA$ISSU$SR" 
  ...
  GRANT INSERT ON "SLS"."SLS$RMA$ISSU$SR" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$RMA$ISSU$SR" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$RMA$ISSU$SR" TO PUBLIC;

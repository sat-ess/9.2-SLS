--------------------------------------------------------
--  DDL for Table SLS$DISC$PLC
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$DISC$PLC" 
  ...
  GRANT INSERT ON "SLS"."SLS$DISC$PLC" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$DISC$PLC" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$DISC$PLC" TO "APP";
  GRANT SELECT ON "SLS"."SLS$DISC$PLC" TO PUBLIC;

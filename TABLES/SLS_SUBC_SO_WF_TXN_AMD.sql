--------------------------------------------------------
--  DDL for Table SLS$SUBC$SO$WF$TXN$AMD
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$SUBC$SO$WF$TXN$AMD" 
   (	"SLOC_ID" NUMBER(2,0), 
  ...
  GRANT INSERT ON "SLS"."SLS$SUBC$SO$WF$TXN$AMD" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$SUBC$SO$WF$TXN$AMD" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$SUBC$SO$WF$TXN$AMD" TO PUBLIC;

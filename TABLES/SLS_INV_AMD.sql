--------------------------------------------------------
--  DDL for Table SLS$INV$AMD
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$INV$AMD" 
  ...
  GRANT UPDATE ON "SLS"."SLS$INV$AMD" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$INV$AMD" TO PUBLIC;
  GRANT INSERT ON "SLS"."SLS$INV$AMD" TO PUBLIC;

--------------------------------------------------------
--  DDL for Table SLS$DISC$PLC$HDR$WF$TXN$AMD
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$DISC$PLC$HDR$WF$TXN$AMD" 
   (	"SLOC_ID" NUMBER(2,0), 
	...
	"AMD_NO" VARCHAR2(50 BYTE), 
	"AMD_DT" DATE
   ) ;
  GRANT UPDATE ON "SLS"."SLS$DISC$PLC$HDR$WF$TXN$AMD" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$DISC$PLC$HDR$WF$TXN$AMD" TO PUBLIC;
  GRANT INSERT ON "SLS"."SLS$DISC$PLC$HDR$WF$TXN$AMD" TO PUBLIC;

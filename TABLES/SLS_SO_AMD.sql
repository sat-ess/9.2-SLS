--------------------------------------------------------
--  DDL for Table SLS$SO$AMD
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$SO$AMD" 
   ...
   COMMENT ON COLUMN "SLS"."SLS$SO$AMD"."ASSIGNED_TO" IS 'TO SAVE SALES REPRESENTATIVE  ';
  GRANT FLASHBACK ON "SLS"."SLS$SO$AMD" TO PUBLIC;
  GRANT DEBUG ON "SLS"."SLS$SO$AMD" TO PUBLIC;
  GRANT QUERY REWRITE ON "SLS"."SLS$SO$AMD" TO PUBLIC;
  GRANT ON COMMIT REFRESH ON "SLS"."SLS$SO$AMD" TO PUBLIC;
  GRANT REFERENCES ON "SLS"."SLS$SO$AMD" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$SO$AMD" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$SO$AMD" TO PUBLIC;
  GRANT INSERT ON "SLS"."SLS$SO$AMD" TO PUBLIC;
  GRANT INDEX ON "SLS"."SLS$SO$AMD" TO PUBLIC;
  GRANT DELETE ON "SLS"."SLS$SO$AMD" TO PUBLIC;
  GRANT ALTER ON "SLS"."SLS$SO$AMD" TO PUBLIC;

--------------------------------------------------------
--  DDL for Table SLS$WMS$PICK$ITEM
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$WMS$PICK$ITEM" 
  ...
  GRANT INSERT ON "SLS"."SLS$WMS$PICK$ITEM" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$WMS$PICK$ITEM" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$WMS$PICK$ITEM" TO PUBLIC;

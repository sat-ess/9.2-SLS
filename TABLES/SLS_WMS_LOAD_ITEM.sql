--------------------------------------------------------
--  DDL for Table SLS$WMS$LOAD$ITEM
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$WMS$LOAD$ITEM" 
  ...
  GRANT INSERT ON "SLS"."SLS$WMS$LOAD$ITEM" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$WMS$LOAD$ITEM" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$WMS$LOAD$ITEM" TO PUBLIC;

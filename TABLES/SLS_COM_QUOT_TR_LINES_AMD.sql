--------------------------------------------------------
--  DDL for Table SLS$COM$QUOT$TR$LINES$AMD
--------------------------------------------------------

  CREATE TABLE "SLS"."SLS$COM$QUOT$TR$LINES$AMD" 
  ...
  GRANT INSERT ON "SLS"."SLS$COM$QUOT$TR$LINES$AMD" TO PUBLIC;
  GRANT SELECT ON "SLS"."SLS$COM$QUOT$TR$LINES$AMD" TO PUBLIC;
  GRANT UPDATE ON "SLS"."SLS$COM$QUOT$TR$LINES$AMD" TO PUBLIC;
